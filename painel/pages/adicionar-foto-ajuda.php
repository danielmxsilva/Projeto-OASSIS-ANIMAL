		...
		if(isset($_POST['acao_adicionar'])){
			...
			if($nome == ''){
				...
				if(Painel::imagemValida($imagem) == true){
					...
					$arr = ['nome_tabela'=>'tb_foto.ajuda','nome'=>$nome,'foto'=>$imagem,'order_id'=>'0'];
					Painel::insert($arr);
					Painel::alert('sucesso','Imagem Adicionada Com Sucesso!');
					Painel::redirect(INCLUDE_PATH_PAINEL.'gerenciar-ajuda');
				}else{
