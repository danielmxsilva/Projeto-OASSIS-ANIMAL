...
<div class="wraper-titulo">
	...
	<a href="<?php echo INCLUDE_PATH_PAINEL?>index.php">
		...
		<h2 class="active-btn">Configuração Doar</h2>
	</div><!--breadcrump-->
</div><!--wraper-titulo-->
...
<div class="box-content">
	...
	<h2>Editar Textos Página Doar</h2>
	...
	<?php
		...
		if(isset($_POST['acao_editar'])){
			if(Painel::updateConfig($_POST)){
				...
				Painel::redirect(INCLUDE_PATH_PAINEL.'configuracao-doar');
			}else{
	...
	<div class="form-editar cadastro-depoimentos">
		<form method="POST" enctype="multipart/form-data">
			...
			<div class="group-depoimento group-textarea">
				<span>CNPJ:</span>
				<input type="text" name="cnpj" value="<?php echo $config['cnpj']?>">
			</div><!--from-group-->
			...
			<div class="group-depoimento group-textarea">
				<span>Pix:</span>
				<input type="text" name="pix" value="<?php echo $config['pix']?>">
			</div><!--from-group-->
			<div class="group-depoimento group-textarea">
				<span>PayPal:</span>
				<input type="text" name="paypal" value="<?php echo $config['paypal']?>">
			</div><!--from-group-->

			<div class="group-depoimento group-textarea">
				<span>Texto Formulário</span>
				<hr style="width: 70%;display: inline-block;height: 3px;background: gray;">
			</div><!--from-group-->

			<div class="group-depoimento group-textarea">
				<span>PayPal:</span>
				<input type="text" name="texto_form" value="<?php echo $config['texto_form']?>">
			</div><!--from-group-->

			<div class="group-depoimento">
				<input type="hidden" name="nome_tabela" value="tb_config.doar">
