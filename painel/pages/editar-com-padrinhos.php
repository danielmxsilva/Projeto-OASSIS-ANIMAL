<?php
	if(isset($_GET['id'])){
		$id = (int)$_GET['id'];
		$noticia_editar = Painel::select('tb_site.apadrinhar','id = ?',array($id));
	}else{
...
<?php include('pages/listar-novos-padrinhos.php')?>

<div class="box-content">
	<img src="<?php echo INCLUDE_PATH_PAINEL;?>img/lapis.png">
	<h2>Adicionar Padrinho</h2>
	<?php
	...
	<div class="form-editar">
		<form method="POST" enctype="multipart/form-data">
			...
			<div class="form-group cadastrar-categoria">
				<span>Padrinho:</span>
				<input type="text" name="nome_padrinho" required value="<?php echo $noticia_editar['padrinho']?>">
			</div><!--from-group-->
			<div class="form-group cadastrar-categoria">
				<span>E-mail:</span>
			...
			<div class="form-group cadastrar-categoria">
				<span>Valor:</span>
				<input type="text" name="valor" required value="<?php echo $noticia_editar['valor']?>">
			</div><!--from-group-->
			<div class="form-group cadastrar-categoria">
				<span>Adquirido:</span>
				<input type="text" name="compra" required value="<?php echo $noticia_editar['compra']?>">
