<?php
	if(isset($_GET['excluir'])){
		...
		Painel::deletar('tb_config.contato',$idExcluir);
		Painel::redirect(INCLUDE_PATH_PAINEL.'gerenciar-contatos');
	}else if(isset($_GET['order']) && isset($_GET['id'])){
		Painel::orderItem('tb_config.contato',$_GET['order'],$_GET['id']);
	}
?>
<div class="wraper-titulo">
		...
		<a href="<?php echo INCLUDE_PATH_PAINEL?>gerenciar-contatos">
			<span>/</span>
			...
			<h2 class="active-btn">Gestão de Contatos</h2>
		</div><!--breadcrump-->
</div><!--wraper-titulo-->
