	...
	<div class="table-wraper">
		...
		?>
			<tbody>
				...
				<td class="tb-editar">
						<a href="<?php echo INCLUDE_PATH_PAINEL?>editar-sem-padrinho?id=<?php echo $value['id']?>"><img src="img/editar-depoimento-verde.png"></a>
				</td>
				<td class="tb-excluir">
						<a <?php
							if($_SESSION['cargo'] >= 1){
						  ?>
						  actionBtn="delete" href="<?php echo INCLUDE_PATH_PAINEL?>sem-padrinhos?excluir=<?php echo $value["id"]?>"
						  <?php }else{ ?> 
